...
long_coord <- as.numeric(char2dms('151°12\′28″E' , chd = "°", chm = "'", chs = "\""))
lat_coord <- as.numeric(char2dms('33°52\′04″S', chd = "°", chm = "'", chs = "\""))
...
m<- leaflet() %>%
  ...
  addLayersControl(overlayGroups = c('Kensington', 'UNSW', 'Sydney GPO'), options = layersControlOptions(collapsed = FALSE))
